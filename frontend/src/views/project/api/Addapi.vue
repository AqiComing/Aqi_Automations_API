                    ...
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            let params = {
                                ...
                                api_group: Number(self.form.apiGroupLevelFirst_id),
                                name: self.form.name,
                                http_type: self.form.httpType,
                                request_type: self.form.requestType,
                                api_address: self.form.apiAddress,
                                status: self.form.status,
                                head_dict: self.form.headDict,
                                request_parameter_type: _type,
                                request_list: _parameter,
                                response_list: self.form.responseList,
